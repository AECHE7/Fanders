<?php
/**
 * Transactions report page for the Library Management System
 */
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && $csrf->validateRequest()) {
    ...
    $filters['status'] = isset($_POST['status']) && !empty($_POST['status']) ? $_POST['status'] : null;
    ...
    if ($generatePdf) {
        // Generate PDF
        $reportService->generateTransactionsReport($filters, true);
        exit; // PDF is output directly
    }
}

// Generate the report with applied filters
$reportData = $reportService->generateTransactionsReport($filters);
...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 py-4">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-3">
                        ...
                        <select name="status" id="status" class="form-select">
                            ...
                            <option value="Borrowed" <?= isset($filters['status']) && $filters['status'] == 'Borrowed' ? 'selected' : '' ?>>Borrowed</option>
    ...
    <div class="card">
        <div class="card-header">
            ...
            <small class="text-muted d-block">Period: <?= $reportData['period'] ?></small>
        </div>
        <div class="card-body">
            ...
            <?php else: ?>
                <div class="mb-3">
                    <strong>Total Transactions:</strong> <?= $reportData['total_transactions'] ?>
                </div>
